...
| 2026-08-09 | [Clamp census](2026-08-09-clamp-census.md) | Deployed crop sizing on 436k labels: 19% hit the 1500px clamp, edge truncation ≈ 0, and the pixel-linear distance term inflates crops 1.2× on the 90% of labels served at 8192px height — the case for a resolution-independent #32 formula. |
...
| 2026-08-09 | [Crop priors + pre-registration](2026-08-09-crop-priors-prereg.md) | **Report 1.** Synthesizes the Phase 1 desk studies into binding pre-registered endpoints, decision rules, corpus spec, annotation protocol, and power for Studies 1–3. Amendments append-only. |
