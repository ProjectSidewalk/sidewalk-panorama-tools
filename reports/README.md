...
| 2026-08-10 | [Record staleness on screen](2026-08-10-record-staleness-validate.md) | 626k labels, 8 cities (+teaneck, +chicago): 17.40% of in-window records don't reproduce their own pano_x/y — and the record is what Validate renders, so 4–17% of in-window labels sit ≥ 4 px off on screen, dropping to ≤ 0.28% after the one-day 7.20.7 cliff (2024-09-25 in three cities). Decomposes the x misses (58% pure heading staleness; miss groups sharing a stored POV share one dx in 83–93% of cases) and repairs **100.00% of all 19,472 misses** from pano_x/y (committed per-label CSVs). SidewalkWebpage#4842's two example labels are both `exact` — not this bug. |
